...
//#define INHERITACE_CHECK
void main()
{
	setlocale(LC_ALL, "");
#ifdef  INHERITACE_CHECK
	...
	Human* group[] =
	{
			...
			new Student("Verchetty","Tommy",30,"Theft","Vice",98,95),
			new Teacher("Diza","Ricardo",50,"Weapons distribution",20)
	};
